const BSUToken = artifacts.require('BSUToken');
...
contract('BSUToken', function ([owner, recipient, anotherAccount]) {
  ...
  describe('total supply', function () {
    it('returns the total amount of tokens', async function () {
      const totalSupply = await this.token.totalSupply();
            ...
            assert.equal(totalSupply, bsuAmount);
    });
  });
    ...
    describe('when the requested account has some tokens', function () {
      it('returns the total amount of tokens', async function () {
        const balance = await this.token.balanceOf(owner);
                ...
                assert.equal(balance, bsuAmount);
      });
    });
  });
  ...
  describe('transfer', function () {
    ...
    describe('when the recipient is the zero address', function () {
      ...
      it('reverts', async function () {
                await assertRevert(this.token.transfer(to, bsuAmount, {from: owner}));
      });
    });
  });
    ...
    describe('when the spender is not the zero address', function () {
      ...
      describe('when the sender has enough balance', function () {
        ...
        describe('when the spender had an approved amount', function () {
          ...
          describe('approves the requested amount and replaces the previous one', function () {
            it('revetrs', async function () {
              await assertRevert(this.token.approve(spender, amount, { from: owner }));
            });
          });

          it('approves the requested amount and replaces the previous one with additional approve', async function () {
  ...
  describe('transfer from', function () {
    ...
    describe('when the recipient is not the zero address', function () {
      ...
      describe('when the spender has enough approved balance', function () {
        beforeEach(async function () {
                    await this.token.approve(spender, bsuAmount, {from: owner});
        });
